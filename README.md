...
## 🌊📏 Example Project: Ultrasonic Sensor with LEDs, LCD Display & Buzzer — Real-World Safety System  

To test this setup, I simulated an **HC-SR04 Ultrasonic Sensor** project designed for a **real-world safety system**.

🔹 The **ultrasonic sensor** continuously measures the distance of nearby objects.  
🔹 **LEDs** visually indicate the proximity of the object:  
&nbsp;&nbsp;&nbsp;🟢 **Green LED** → Safe distance  
&nbsp;&nbsp;&nbsp;🟡 **Yellow LED** → Object nearby  
&nbsp;&nbsp;&nbsp;🔴 **Red LED** → Object very close  
🔹 A **buzzer** provides an audible warning when an object gets too close.  
🔹 The **LCD display** shows the **real-time distance (in cm)** along with **status messages** for clear feedback.  

This project demonstrates how **embedded systems and sensors** can work together to enhance **safety and awareness** in real-life applications — all simulated virtually through **PlatformIO + WOKWI**.  
It’s an excellent way to **practice Arduino coding, sensor integration, and logic design** without any physical hardware. 🚀  

<img width="900" alt="Ultrasonic Sensor Simulation Demo" src="https://github.com/Subhagaya-Git/PlatformIO-with-WOKWI-Simulation/blob/main/src/Ultrasonic_Sensor_Simulation.gif?raw=true" />
